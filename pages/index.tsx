      ...
      <div onWheel={(e) => {e?setWheel(e.pageY):null}}>
        ...
        <div className={styles.heroContainer}>
          <div className={styles.blackGradientBottom2}>
            <Navbar/>
            <div className={styles.heroContentWrap} id="omniverse" ref={omniverseSection}>
                <h1>Omniverse</h1>
            ...
            <div className={styles.featureContentWrap}>
              ...
              <div className={styles.ContentWrap}  id="overview"  ref={overviewSection}>
        ...
        <div className={styles.HomePageBg}>
          {/* Feature Section */}
          {/* Slider Section */}
          <div className={styles.sliderRootContainer} ref={omniwarsSection} id="omniwars">
          ...
          {/* Roadmap Section */}
          <div className={styles.roadmapSecHead} ref={roadmapSection} id="roadmap">
            <div className={styles.secHeadingCon}>
              <div className={styles.secHeadingWrap}>
                <div className={styles.secHeadImgL}>
                  <Image src={SecHeadArrowL} layout="responsive" alt="arrow"></Image>
